---
name: log-analysis
description: Use when parsing security logs or building SIEM content - Splunk SPL, Elastic/KQL, QRadar AQL and Microsoft Sentinel queries, Sigma rule authoring, log correlation rules, and statistical anomaly detection. For hunt methodology and detection strategy use threat-hunting; this skill is the query and parsing layer.
version: 3.0.0
author: Masriyan
