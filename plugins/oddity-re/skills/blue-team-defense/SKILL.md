...
description: Use when hardening a system or improving defensive posture - CIS baselines, endpoint and network hardening, detection engineering, patch management, defense-in-depth architecture, and security posture measurement. The defensive counterpart to the offensive privesc and evasion skills.
version: 3.0.0
author: Masriyan
