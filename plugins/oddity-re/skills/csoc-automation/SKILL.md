...
description: Use when running SOC operations day to day - alert triage queues, incident playbook automation, escalation workflows, shift handover reports, and SOC KPI tracking. Defensive operations; for offensive engagement flow use engagement-flow instead.
version: 3.0.0
author: Masriyan
