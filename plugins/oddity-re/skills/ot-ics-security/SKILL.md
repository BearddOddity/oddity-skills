...
description: Use when assessing an OT, ICS or SCADA environment - Purdue model segmentation review, industrial protocol analysis (Modbus, DNP3, S7, EtherNet/IP), PLC and HMI exposure, IEC 62443 alignment, and MITRE ATT&CK for ICS. Safety-conscious and authorized assessments only.
version: 3.0.0
author: Masriyan
